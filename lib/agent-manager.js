...
export class AgentManager extends EventEmitter {
  ...
  async prompt(id, textOrOpts) {
    ...
    //   formal ACP resource_link blocks so the agent treats the attachments
    //   as first-class file references (not just text). Some agents key off
    //   resource_link to route through a vision pipeline.
